    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">All scheduled and published pins</p>
        </div>
      ...
      {!pins?.length ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          <div className="grid grid-cols-[auto,1fr,auto,auto] gap-4 px-5 py-3 border-b border-gray-50 text-xs font-semibold text-gray-400 uppercase tracking-wider">
            <span>Image</span>
            <span>Title</span>
            <span>Scheduled</span>
            <span>Status</span>
          ...
          <div className="divide-y divide-gray-50">
            {pins.map((pin) => (
              <div
                key={pin.id}
                className="grid grid-cols-[auto,1fr,auto,auto] gap-4 px-5 py-4 items-center hover:bg-gray-50/50 transition-colors"
              >
