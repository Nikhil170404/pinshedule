...
export const metadata = {
  title: 'Terms of Service — PinScheduleKaro',
}

const sections = [
  { id: '1', title: 'Acceptance', body: 'By using PinScheduleKaro, you agree to these Terms. If you disagree, do not use the service.' },
  { id: '2', title: 'Eligibility', body: 'You must be 18+ to use PinScheduleKaro. By using our service, you confirm you are 18+.' },
  ...
  { id: '5', title: 'Pinterest account', body: 'You must have a valid Pinterest Business or Creator account. You authorize PinScheduleKaro to access your Pinterest account via official Pinterest API. You can revoke access at any time from Pinterest settings. We are not responsible for Pinterest API changes or downtime.' },
